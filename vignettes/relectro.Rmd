...
---
This vignette documents the use of the relectro package. relectro is being developped to analyze data from electrophysiological experiments in R. The main aim of this package is to allow users to do common analysis of electrophysiological data within R. relectro relies on several C functions for computationally intensive segment of the code. This increases the speed of the analysis to a respectable level. 
