...
It is often useful to create and load the spike trains, position data, dat file information, cell infomration when analysing data in a recording session. You can do this by calling \code{getRecSessionObjects}. This will return a list of loaded objects ready to use.
```{r loadObject}
  ## the long way
