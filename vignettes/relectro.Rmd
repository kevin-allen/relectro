...
---
This vignette documents the relectro R package. relectro is being developped to analyze data from electrophysiological experiments in R. The main aim of this package is to allow users to do common analysis of electrophysiological data within R. The focus is on data recorded with tetrodes. relectro relies on several C functions in computationally intensive segments of the code.
