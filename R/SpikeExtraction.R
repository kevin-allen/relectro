...
#' @param simultaneousSpikeMaxJitterMs Maximum jitter between two detected spikes to be consider the same spike
...
createSpkFile<-function(rs,channnels,res,window=32,tetrodeNumber){
